...
from core.proxy import egress as egress_mod
from core.proxy.egress import _extract_ip, _is_valid_ip, resolve_egress_ip
from core.proxy.transport import _NormalizingTransport

from tests.conftest import as_async, fake_proxy_session
