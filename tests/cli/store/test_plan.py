...
from core.domain.types import Doc, DocKind, RucKind, Site

from tests.conftest import accepts_ruc_kinds as _accepts_ruc_kinds
from tests.conftest import fake_site
