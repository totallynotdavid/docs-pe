...
from fetch.obs.events import EGRESS_IP_UNRESOLVED, SESSION_READY, STICKY_ACQUIRE
from fetch.obs.logging import kv, new_session_id
from fetch.proxy.egress import resolve_egress_ip
from fetch.proxy.transport import build_transport


if TYPE_CHECKING:
    from fetch.domain.types import Site
    from fetch.proxy.base import ProxyProvider, ProxySession
