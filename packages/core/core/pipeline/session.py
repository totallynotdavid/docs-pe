...
from core.obs.events import EGRESS_IP_UNRESOLVED, SESSION_READY, STICKY_ACQUIRE
from core.obs.logging import kv, new_session_id
from core.proxy.egress import resolve_egress_ip
from core.proxy.transport import build_transport


if TYPE_CHECKING:
    from core.domain.types import Site
    from core.proxy.base import ProxyProvider, ProxySession
