...
-- Unsupported legacy configurations cannot be mapped safely. Existing jobs
-- retain their version, but new work requires a validated replacement.
UPDATE portal_team_proxy_credential_versions
   SET provider = 'geonode',
       lifecycle = 'retired',
       is_active = false,
...
DROP INDEX IF EXISTS portal_active_credential_version_idx;
