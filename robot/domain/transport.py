...
from robot.domain.errors import BanSignalError, RobotError, TransientTransportError
...
def classify_status(status: int) -> type[RobotError] | None:
...
async def warm_endpoints(
    ...
    """A GET-and-classify check per endpoint marked warm=True.
